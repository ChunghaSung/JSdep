...
3. We have a virtual disk image with full configuration. However, because of limitation of size we cannot upload it (The size is about 3.6 GB). If you want to use it, please contact Chungha.
