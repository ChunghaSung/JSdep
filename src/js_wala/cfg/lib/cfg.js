...
define(function(require, exports) {
   ...
   */
    function buildStmtCFG(stmt, following, context, accu) {
      ...
      case 'IfStatement':
        if (stmt.consequent.body === undefined) {
            addEdge(stmt, stmt.consequent);
        } else {
      ...
      case 'ForInStatement':
      case 'ForStatement':
        if (stmt.body.body === undefined) {
            addEdge(stmt, stmt.body);
        } else {
