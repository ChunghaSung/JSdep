...
QUrl parseCmd(int argc, char* argv[], artemis::Options& options)
{
    ...
    while ((c = getopt_long(argc, argv, "hsrp:f:t:c:i:v:q:", long_options, &option_index)) != -1) {
