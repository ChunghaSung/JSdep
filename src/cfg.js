var ast = require('./js_wala/common/lib/ast.js'),
    sets = require('./js_wala/common/lib/sets.js'),
    cfg = require('./js_wala/cfg/lib/cfg'),
    dominators = require('./js_wala/cfg/lib/dominators');
var falafel = require('falafel');

module.exports = {
    makeCFG : function (code) {
        "use strict";
        var ast;
    ...
    buildDominatorTrees : function (ast) {
        "use strict";
        dominators.buildDominatorTrees(ast, true);
        return ast;
    }, 

    printCFG : function (ast) {
        "use strict";
